		...
		function render_meta_box($post) {
			...
			<div id="global-page-wrapper">
				<label>
					...
					<input type="checkbox" name="wpfa_is_global_page" <?php checked($checked); ?>> <?php echo __('Apply changes to all the subsites?', 'vg_admin_to_frontend'); ?> <a href="#" title="<?php esc_attr_e('If you select this option, we will find all the pages with same slug in all the subsites of the multisite network and synchronize all the page information (except the featured image)', 'vg_admin_to_frontend'); ?>">(?)</a>
				</label>

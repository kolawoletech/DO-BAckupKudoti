...
namespace VendorFPF\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-product-fields';
     ...
     */
    public function __construct($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, array $requirements, $product_id, \VendorFPF\WPDesk\Plugin\Flow\Initialization\InitializationFactory $build_factory)
    {
     ...
     */
    private function init_translations(\VendorFPF\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \VendorFPF\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \VendorFPF\WPDesk_Plugin_Info();
